...
// 定义缓存清理类型(host: 清除指定域名全部缓存)
$type = 'host';
// 定义要清除缓存对象(清除指定域名全部缓存)
$urls = 'https://'.$host.'.'.$domain;
// $urls = 'http://'.$host.'.'.$domain;

// 定义要清除缓存对象(url: 清除指定URL地址缓存)
// $type = 'url';
// 定义要清除缓存对象(清除指定URL地址缓存, 多个url之间使用\n分隔)
// $urls = "http://www.example.com/test.jpg\nhttps://www.example.com/index.html\n...";
